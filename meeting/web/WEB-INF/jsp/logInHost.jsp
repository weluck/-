...
<div class="container">
    ...
    <form method="post" action="${pageContext.request.contextPath}/meeting/checkHost" class="form-signin">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form method="post" action="${pageContext.request.contextPath}/meeting/addHost">
                    <div class="hidden">
                        <label for="0">账号</label>
                        <input name="meetId" type="text" class="form-control" id="0" placeholder="account">
                    </div>
    ...
    <script language="javascript">
        window.onload = function() {
            ...
            if (temp != null) {
                if (temp == 1) {
                    window.location.replace("${pageContext.request.contextPath}/meeting/host")
                }
                if (temp == 2) {
                    alert("用户名或密码错误！")
                }
